<template>
    <header>
        <nav class="sticky top-0 inset-x-0 flex items-center justify-between flex-wrap bg-gradient-to-r from-blue-900 to-cyan-500 p-6">
    ...
    <body class="bg-gray-100">
        <div class="grid grid-cols-4 gap-5">
            <div v-for="c in data.data" class="bg-white m-2 rounded-sm shadow-md">
                <div class="bg-gradient-to-r from-cyan-500 to-cyan-400 text-white rounded-t-sm">
