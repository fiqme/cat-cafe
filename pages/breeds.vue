    ...
    <body class="bg-gray-100">
        <div class="grid grid-cols-4 gap-5 m-2">
            <div v-for="c in data.data" class="bg-white m-2 rounded-sm shadow-md hover:scale-105">
                ...
                <div class="grid place-content-center border border-t-gray-200 border-b-0">
                    <svg class="w-5 hover:cursor-pointer" fill="none" stroke="gray" stroke-width="1" viewBox="0 0 24 24"
