<template>
    <header>
        <nav
            class="sticky top-0 inset-x-0 flex items-center justify-between flex-wrap bg-gradient-to-r from-blue-900 to-cyan-500 p-6">
            <div class="flex items-center flex-shrink-0 text-white mr-6">
                <NuxtLink to="/" class="hover:cursor-pointer flex">
                    <!-- cat paw icon -->
